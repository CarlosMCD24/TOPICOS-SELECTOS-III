...
def launch_instance():
    ...
    with open(r'C:\Users\INIFAP-MOVIL\Documents\4 CUARTO SEMESTRE\Topicos Selectos de Grandes Bass de Datos III\AWS\TOPICOS-SELECTOS-III\Almacenamiento de logs en S3 con Kinesis Firehose\aws_exercise\user_data.sh', 'r', encoding='utf-8') as f:
